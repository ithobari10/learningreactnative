...
import { FoodDummy8, IconbackWhite } from '../../assets'
    ...
    return (
        <View style={styles.page}>
            <ImageBackground source={FoodDummy8} style={styles.cover}>
                <TouchableOpacity>
                    <IconbackWhite style={styles.back} />
                </TouchableOpacity>
            </ImageBackground>
            <View style={styles.content}>
                <View style={styles.mainContent}>
                    <View style={styles.productContainer}>
                        <View>
                            <Text style={styles.title}>Cherry Pick</Text>
                            <Rating />
                        </View>
                        <Counter />
                    </View>
...
const styles = StyleSheet.create({
    ...
    desc: {fontSize:14, fontFamily: 'Poppins-Regular', color:'#8D92A3', marginBottom:16},
    ...
    priceTotal: {fontSize: 13, fontFamily: 'Poppins-Regular', color: '#020202'},
})